<div class="content-header">
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
        <h3 class="m-0">Cadastro de agentes</h3>
        </div><!-- /.col -->
        <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="./home">Home</a></li>
            <li class="breadcrumb-item active">cadastraragente</li>
        </ol>
        </div><!-- /.col -->
    </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
        <!-- jquery validation -->
        <div class="card card-success cadastrarAgentes">
            <div class="card-header">
                <h3 class="card-title">Dados do agente</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form method="POST" id="cadastrarAgentes">
                <div class="card-body">
                    <div class="row">
                        <!--Left column-->
                        <div class="col-md-6">
